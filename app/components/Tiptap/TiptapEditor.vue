...
import TiptapToolbarButton from "@/Components/Tiptap/TiptapToolbarButton.vue";
import TiptapToolbarGroup from "@/Components/Tiptap/TiptapToolbarGroup.vue";
...
import TiptapLinkDialog from "@/Components/Tiptap/TiptapLinkDialog.vue";
import TiptapVideoDialog from "@/Components/Tiptap/TiptapVideoDialog.vue";
import TiptapTableDialog from "@/Components/Tiptap/TiptapTableDialog.vue";
import TiptapImageDialog from "@/Components/Tiptap/TiptapImageDialog.vue";
...
const editorInstance = useEditor({
    ...
    extensions: [
        ...
        BulletList.configure({
            HTMLAttributes: {
                class: "w-full pl-10 space-y-1 text-gray-500 list-disc",
            },
        }),
        OrderedList.configure({
            HTMLAttributes: {
                class: "w-full pl-10 space-y-1 text-gray-500 list-decimal",
            },
        }),
        Link.configure({
            openOnClick: false,
        ...
        Blockquote.configure({
            HTMLAttributes: {
                class: "border-l-2 ml-10 border-gray-300 pl-4",
            },
        }),
        CharacterCount,
        Youtube,
        ...
        Table.configure({
            HTMLAttributes: {
                class: "min-w-full border-1 border-gray-300",
            },
        }),
        TableRow.configure({
            HTMLAttributes: {
...
watch(
    () => props.modelValue,
    (newValue) => {
        if (newValue !== editorInstance.value?.getHTML()) {
